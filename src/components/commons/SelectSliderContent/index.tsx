...
const users: User[] = [
    ...
    {id: 1, name: "name4", email: "1.doe@example.com"},
    {id: 2, name: "name5", email: "2@example.com"},
    {id: 3, name: "name6", email: "3@example.com"},
    {id: 1, name: "name7", email: "1.doe@example.com"},
    {id: 2, name: "name8", email: "2@example.com"},
    {id: 3, name: "name8", email: "3@example.com"},
];
export const data = [
...
const SelectSliderContent = () => {
    ...
    return (
        <div
            ...
            >
                {data.map((animal) => (
                    <SelectItem className={"bg-black"} color={"primary"} key={animal.key}>
                        {animal.label}
                    </SelectItem>
                ))}
            </CustomSelect>
            ...
            >
                {users.map((item: any, index) => (
                    <SelectItem className={"text-black"} key={index} value={item}>
                        {item.name}
                    </SelectItem>
                ))}
            </CustomSelect>
